...
//-------------------------------------------
#define REAR_LEFT_DRIVE_MOTOR_CAN_ID       4 //1
#define REAR_LEFT_STEER_MOTOR_CAN_ID       5 //2
#define REAR_LEFT_STEER_ENCODER_CAN_ID     6 //3
//-------------------------------------------
#define REAR_RIGHT_DRIVE_MOTOR_CAN_ID      10 //7
#define REAR_RIGHT_STEER_MOTOR_CAN_ID      11 //8
#define REAR_RIGHT_STEER_ENCODER_CAN_ID    12 //9
//-------------------------------------------
