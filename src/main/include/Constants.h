...
//-------------------------------------------
#define FRONT_LEFT_DRIVE_MOTOR_CAN_ID      10
#define FRONT_LEFT_STEER_MOTOR_CAN_ID      11
#define FRONT_LEFT_STEER_ENCODER_CAN_ID    12
//-------------------------------------------
#define FRONT_RIGHT_DRIVE_MOTOR_CAN_ID     4
#define FRONT_RIGHT_STEER_MOTOR_CAN_ID     5
#define FRONT_RIGHT_STEER_ENCODER_CAN_ID   6
//-------------------------------------------
#define REAR_LEFT_DRIVE_MOTOR_CAN_ID       1
#define REAR_LEFT_STEER_MOTOR_CAN_ID       2
#define REAR_LEFT_STEER_ENCODER_CAN_ID     3
//-------------------------------------------
#define REAR_RIGHT_DRIVE_MOTOR_CAN_ID      7
#define REAR_RIGHT_STEER_MOTOR_CAN_ID      8
#define REAR_RIGHT_STEER_ENCODER_CAN_ID    9
//-------------------------------------------
